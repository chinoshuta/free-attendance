/*
  ...
  - You are about to drop the column `created_at` on the `attendances` table. All the data in the column will be lost.
  - You are about to drop the column `project_id` on the `attendances` table. All the data in the column will be lost.
  - You are about to drop the column `updated_at` on the `attendances` table. All the data in the column will be lost.
  ...
  - Added the required column `projectId` to the `attendances` table without a default value. This is not possible if the table is not empty.
...
*/
-- DropForeignKey
ALTER TABLE "attendances" DROP CONSTRAINT "attendances_project_id_fkey";

-- DropForeignKey
ALTER TABLE "projects" DROP CONSTRAINT "projects_user_id_fkey";

-- AlterTable
ALTER TABLE "attendances" DROP COLUMN "created_at",
